...
(function() {
  ...
  on('click', '.scrollto', function(e) {
    // Always prevent default for scrollto links
    e.preventDefault()
    ...
    // Custom scroll logic for each section
    if (this.hash === '#skills') {
      ...
      let sections = document.querySelectorAll('section#contact');
      if (sections.length > 0) {
        window.scrollTo({ top: sections[0].offsetTop, behavior: 'smooth' });
      }
    } else if (this.hash === '#resume') {
      // Scroll to the <section id="resume"> element
      let resumeSection = document.querySelector('section#resume');
      if (resumeSection) {
